    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-zinc-50 dark:bg-zinc-950">
        <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-600 p-8 max-w-md text-center shadow-[8px_8px_0px_0px_rgba(185,28,28,1)]">
          <h2 className="font-black text-red-600 dark:text-red-400 text-xl uppercase mb-2">Account Rejected</h2>
          <p className="font-bold text-zinc-700 dark:text-zinc-300">Your account has been rejected. Please contact the administrator for more details.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center gap-4">
        {user && (
          <div className="text-xs font-mono hidden sm:block">
            {user.email} <span className="uppercase font-bold text-orange-500 ml-2">[{user.role}]</span>
          </div>
        )}
        {user && user.role === 'admin' && (
          <Link to="/admin" className="text-xs font-bold uppercase hover:underline text-emerald-600 dark:text-emerald-400">
            Admin Dashboard
          </Link>
        )}
        <button 
...
import { Users, BookOpen, FileText, CreditCard, ArrowLeft, Layers } from 'lucide-react';
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto flex flex-col h-full">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl sm:text-3xl font-black italic uppercase leading-none mb-2">Admin Dashboard</h2>
          <p className="text-zinc-500 text-sm font-medium">Manage your tuition center</p>
        </div>
      </div>

      <div className="mb-6 bg-yellow-100 dark:bg-yellow-900/30 border-4 border-yellow-500 p-4">
        <h3 className="font-black text-yellow-800 dark:text-yellow-500 uppercase mb-2">🚀 TEST SETUP GUIDE</h3>
        ...
        <ul className="list-disc pl-5 text-sm font-bold text-yellow-800 dark:text-yellow-200 space-y-1 mb-4">
           <li>Go to <strong>Students Management</strong> to create virtual students and assign them to a Batch.</li>
           <li>Go to <strong>Payments Management</strong> &rarr; Click their Batch to configure their monthly fee.</li>
           <li>Use the <strong className="text-black dark:text-white bg-yellow-300 dark:bg-yellow-700 px-1">SIMULATION MODE</strong> toolbar (top) to log in as them and test fee payments!</li>
        </ul>
        <Link to="/admin/students" className="inline-block bg-yellow-500 text-black font-black uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform border-2 border-yellow-800 shadow-[2px_2px_0px_0px_rgba(133,77,14,1)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-min flex-grow">
        ...
        <div className="md:col-span-4 bg-indigo-50 dark:bg-indigo-950 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] dark:shadow-[6px_6px_0px_0px_rgba(244,244,245,1)] flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="font-black text-xl text-indigo-900 dark:text-indigo-100 uppercase mb-1">Batches</h3>
                <p className="text-xs font-bold text-indigo-700 dark:text-indigo-300 uppercase">Manage Classes</p>
              </div>
          ...
          <Link to="/admin/batches" className="inline-block bg-indigo-500 text-white dark:text-zinc-900 font-bold uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform border-2 border-zinc-900 dark:border-zinc-100 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] dark:shadow-[4px_4px_0px_0px_rgba(244,244,245,1)]">
            Manage Batches
          </Link>
        </div>
          ...
          <div>
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-xs font-bold text-zinc-500 uppercase">Approval & management</p>
              </div>
            ...
            <div className="text-sm font-medium text-zinc-600 dark:text-zinc-400 mb-4">
              View pending approvals, assign students to batches, and manage profiles.
            </div>
          </div>
          <Link to="/admin/students" className="inline-block bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-bold uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform shadow-[4px_4px_0px_0px_rgba(161,161,170,1)] dark:shadow-[4px_4px_0px_0px_rgba(82,82,91,1)] border-2 border-transparent">
            Manage Students
          </Link>
        </div>
        ...
        <div className="md:col-span-4 bg-orange-50 dark:bg-orange-950 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] dark:shadow-[6px_6px_0px_0px_rgba(244,244,245,1)] flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="font-black text-xl text-orange-900 dark:text-orange-100 uppercase mb-1">Central Library</h3>
                <p className="text-xs font-bold text-orange-700 dark:text-orange-300 uppercase">PDF Notes & Content</p>
              </div>
          ...
          <Link to="/admin/library" className="inline-block bg-orange-500 text-white font-bold uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform border-2 border-zinc-900 dark:border-zinc-100 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] dark:shadow-[4px_4px_0px_0px_rgba(244,244,245,1)]">
            Open Library
          </Link>
        </div>
        ...
        <div className="md:col-span-6 bg-zinc-900 dark:bg-zinc-100 text-zinc-100 dark:text-zinc-900 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(161,161,170,1)] dark:shadow-[6px_6px_0px_0px_rgba(82,82,91,1)] flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="font-black text-xl uppercase mb-1">Exam Engine</h3>
                <p className="text-xs font-bold text-zinc-400 dark:text-zinc-600 uppercase">Tests & Results</p>
              </div>
          ...
          <Link to="/admin/results" className="inline-block bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-white font-bold uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform shadow-[4px_4px_0px_0px_rgba(161,161,170,1)] border-2 border-zinc-900 dark:border-zinc-100">
            View Results
          </Link>
        </div>
          ...
          <div>
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-xs font-bold text-yellow-800 dark:text-yellow-950 uppercase">Fees & Tracking</p>
              </div>
            ...
            <div className="text-sm font-medium text-yellow-900 dark:text-yellow-100 mb-4">
              Track student payments, approve or reject submissions, view history.
            </div>
          </div>
          <Link to="/admin/payments" className="inline-block bg-white dark:bg-zinc-900 dark:text-white font-bold uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform border-2 border-zinc-900 dark:border-zinc-100 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)]">
            Open Payments
          </Link>
        </div>
        ...
        <div className="md:col-span-12 bg-sky-200 dark:bg-sky-900 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] dark:shadow-[6px_6px_0px_0px_rgba(244,244,245,1)] flex flex-col justify-between">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div className="mb-4 md:mb-0">
              <h3 className="font-black text-xl uppercase mb-1 text-sky-900 dark:text-sky-100">Student Simulator</h3>
              <p className="text-sm font-medium text-sky-800 dark:text-sky-200 max-w-xl">
                Experience the application exactly as a student would. You can select a batch, navigate through exams, notes, and the dashboard to verify everything works flawlessly before sharing it with students.
              </p>
            </div>
            <Link to="/student" className="inline-block bg-sky-600 text-white font-bold uppercase text-xs px-6 py-3 hover:-translate-y-0.5 transition-transform border-2 border-zinc-900 dark:border-zinc-100 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] dark:shadow-[4px_4px_0px_0px_rgba(244,244,245,1)] whitespace-nowrap">
              Launch Simulator
            </Link>
          </div>
        </div>
        ...
        <div className="md:col-span-12 lg:col-span-12 bg-zinc-100 dark:bg-zinc-800 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] dark:shadow-[6px_6px_0px_0px_rgba(244,244,245,1)] flex flex-col justify-between">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div className="mb-4 md:mb-0">
              <h3 className="font-black text-xl text-zinc-900 dark:text-zinc-100 uppercase mb-1">Platform Settings</h3>
              <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200 max-w-xl">
                Configure UPI Payment details, toggle the payment system, and manage other global platform features.
              </p>
            </div>
            <Link to="/admin/settings" className="inline-block bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-bold uppercase text-xs px-6 py-3 hover:-translate-y-0.5 transition-transform border-2 border-zinc-900 dark:border-zinc-100 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] dark:shadow-[4px_4px_0px_0px_rgba(244,244,245,1)] whitespace-nowrap">
              Open Settings
            </Link>
          </div>
        </div>
...
function StudentDashboard() {
  ...
  const [paymentStatus, setPaymentStatus] = useState<{status: string, label: string, color: string}>({status: 'paid', label: 'All Paid Up', color: 'text-emerald-600 dark:text-emerald-400'});
  const [showNudge, setShowNudge] = useState(false);

  useEffect(() => {
    // Check nudge popup
    if (user && (user as any).showPaymentNudge && (user as any).monthlyFee > 0 && (user as any).pendingMonths > 0) {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const payQ = query(collection(db, 'payments'), where('studentId', '==', user.uid));
        const paySnaps = await getDocs(payQ);
        const pData: Payment[] = [];
        paySnaps.forEach(d => pData.push({ id: d.id, ...d.data() } as Payment));
        ...
        if (pData.length > 0) {
           ...
           if (latest.status === 'pending') {
              setPaymentStatus({status: 'pending', label: 'Pending Review', color: 'text-yellow-600 dark:text-yellow-400'});
           } else if (latest.status === 'rejected') {
              setPaymentStatus({status: 'rejected', label: 'Rejected', color: 'text-red-600 dark:text-red-400'});
           } else {
              setPaymentStatus({status: 'paid', label: 'All Paid Up', color: 'text-emerald-600 dark:text-emerald-400'});
           }
        }
    ...
    return (
      <div className="p-6 max-w-2xl mx-auto mt-8">
         <div className="bg-yellow-50 dark:bg-yellow-950 border-2 border-yellow-600 dark:border-yellow-400 p-6 shadow-[6px_6px_0px_0px_rgba(202,138,4,1)]">
            <h2 className="text-xl font-black uppercase mb-2 text-yellow-800 dark:text-yellow-200">Pending Approval</h2>
            <p className="text-yellow-700 dark:text-yellow-300">Your account is created but waiting for admin approval. Please wait for the teacher to verify your account and assign you to a batch.</p>
         </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto flex flex-col h-full relative">
      {showNudge && (
         <div className="fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-4">
            <div className="bg-white dark:bg-zinc-900 border-4 border-red-600 dark:border-red-500 w-full max-w-sm p-6 text-center transform transition-all scale-100 shadow-[8px_8px_0px_0px_rgba(220,38,38,1)]">
               ...
               <h2 className="text-xl font-black uppercase mb-2 text-red-600">Payment Reminder</h2>
               <p className="mb-4 font-bold text-sm text-zinc-700 dark:text-zinc-300">
                  Your monthly salary/fee for <span className="text-red-600 dark:text-red-400">{(user as any).pendingMonths} month{((user as any).pendingMonths || 1) > 1 ? 's' : ''}</span> is pending.
               </p>
               <p className="mb-6 text-xs text-zinc-500 dark:text-zinc-400 font-mono">
                  Monthly Fee: ₹{(user as any).monthlyFee}
               </p>
               <button onClick={() => setShowNudge(false)} className="w-full border-2 border-red-600 bg-red-600 text-white font-bold uppercase py-3 hover:-translate-y-0.5 shadow-[4px_4px_0px_0px_rgba(153,27,27,1)] transition-transform active:translate-y-0 active:shadow-[0px_0px_0px_0px_rgba(153,27,27,1)]">
                  I Understand, Close
               </button>
            </div>
         </div>
      ...
      <div className="flex justify-between items-center mb-6 mt-8">
        <div>
          <h2 className="text-2xl sm:text-3xl font-black italic uppercase leading-none mb-2">Student Dashboard</h2>
          <p className="text-zinc-500 text-sm font-medium">Welcome back, {user?.fullName || user?.displayName || 'Student'}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-min flex-grow">
       ...
       <div className="md:col-span-12 bg-white dark:bg-zinc-900 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] dark:shadow-[6px_6px_0px_0px_rgba(244,244,245,1)] flex flex-col md:flex-row gap-6 items-center md:items-start">
         <div className="flex-grow w-full">
            <h3 className="font-black text-xl uppercase mb-4 border-b-2 border-zinc-200 dark:border-zinc-800 pb-2">My Profile Details</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
               <div><span className="font-bold text-zinc-500 uppercase text-xs block">Full Name:</span> <div className="font-bold">{user?.fullName || 'N/A'}</div></div>
               <div><span className="font-bold text-zinc-500 uppercase text-xs block">Phone:</span> <div className="font-bold">{user?.phone || 'N/A'}</div></div>
               <div className="sm:col-span-2"><span className="font-bold text-zinc-500 uppercase text-xs block">Address:</span> <div className="font-bold whitespace-pre-wrap">{user?.address || 'N/A'}</div></div>
               <div><span className="font-bold text-zinc-500 uppercase text-xs block">Email:</span> <div className="font-bold">{user?.email}</div></div>
               <div><span className="font-bold text-zinc-500 uppercase text-xs block">Joined Data:</span> <div className="font-bold">{user?.joinDate || 'N/A'}</div></div>
            </div>
            <p className="text-[10px] uppercase font-bold text-red-500 mt-4 border border-red-200 bg-red-50 p-2 dark:bg-red-950/20 dark:border-red-900">Note: Profile details are fixed. Contact the admin to update them.</p>
         </div>
       </div>
        ...
        <div className="md:col-span-8 bg-zinc-900 dark:bg-zinc-100 text-zinc-100 dark:text-zinc-900 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(161,161,170,1)] dark:shadow-[6px_6px_0px_0px_rgba(82,82,91,1)]">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h3 className="font-black text-xl uppercase mb-1">Recent Exams</h3>
              <p className="text-xs font-bold text-zinc-400 dark:text-zinc-600 uppercase">Latest assigned to you</p>
            </div>
            <div className="bg-zinc-800 dark:bg-zinc-200 p-2 border-2 border-zinc-700 dark:border-zinc-300">
              <FileText className="w-6 h-6" />
            </div>
          ...
          <div className="mb-6 space-y-3">
             {exams.length === 0 ? (
               ...
               exams.map(exam => {
                 ...
                 const dateStr = d ? d.toLocaleDateString('en-IN', { weekday: 'short', month: 'short', day: 'numeric' }) : '';
                 return (
                 <div key={exam.id} className="flex justify-between items-center bg-zinc-800 dark:bg-zinc-200 p-3 border border-zinc-700 dark:border-zinc-300 gap-4">
                   <div className="flex-grow">
                     <div className="font-bold flex items-center gap-2">
                       {exam.title}
                       <span className="text-[9px] bg-zinc-700 dark:bg-zinc-300 px-1 py-0.5 rounded-sm uppercase">{exam.examType || 'Exam'}</span>
                     </div>
                     <div className="text-xs text-zinc-400 dark:text-zinc-500">Added: {dateStr}</div>
                   </div>
                   <div className="flex flex-col gap-1 items-end min-w-[80px]">
                     <Link to="/student/library" className="text-[10px] font-bold uppercase underline hover:text-emerald-500 text-emerald-600 dark:text-emerald-400">Open Exam</Link>
                   </div>
                 </div>
                 );
               })
          ...
          <Link to="/student/library" className="inline-block bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-white font-bold uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform shadow-[4px_4px_0px_0px_rgba(212,212,216,1)] dark:shadow-[4px_4px_0px_0px_rgba(63,63,70,1)] border-2 border-transparent">
        ...
        <div className="md:col-span-4 bg-yellow-300 dark:bg-yellow-600 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] dark:shadow-[6px_6px_0px_0px_rgba(244,244,245,1)] text-zinc-900 flex flex-col justify-between">
          <div>
            <h3 className="font-black text-xl uppercase mb-1">Payments</h3>
            <p className="text-xs font-bold text-yellow-800 dark:text-yellow-950 uppercase">Account Status</p>
          </div>
          <div className="mt-4 p-4 bg-white dark:bg-zinc-900 border-2 border-zinc-900 dark:border-zinc-100">
             ...
             <div className={`font-bold uppercase mb-4 ${paymentStatus.color}`}>{paymentStatus.label}</div>
             <Link to="/student/payments" className="inline-block bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-bold uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform border-2 border-transparent shadow-[4px_4px_0px_0px_rgba(161,161,170,1)]">
               Make Payment
             </Link>
          </div>
        </div>
        ...
        <div className="md:col-span-12 bg-white dark:bg-zinc-900 border-2 border-zinc-900 dark:border-zinc-100 p-6 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] dark:shadow-[6px_6px_0px_0px_rgba(244,244,245,1)] mt-4">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h3 className="font-black text-xl uppercase mb-1">Recent Library Additions</h3>
              <p className="text-xs font-bold text-zinc-500 uppercase">Latest PDF Notes & Handouts</p>
            </div>
          ...
          <div className="mb-6 flex flex-wrap gap-4">
             {notes.length === 0 ? (
               ...
               notes.map(note => {
                 ...
                 const dateStr = d ? d.toLocaleDateString('en-IN', { weekday: 'short', month: 'short', day: 'numeric' }) : '';
                 return (
                 <Link to="/student/library" key={note.id} className="bg-orange-50 dark:bg-orange-950 border border-orange-200 dark:border-orange-800 p-3 hover:-translate-y-1 transition-transform min-w-[200px] flex flex-col justify-between">
                   <div className="font-bold text-orange-900 dark:text-orange-50">{note.title}</div>
                   <div className="flex justify-between items-end mt-2">
                      <div className="text-[10px] text-zinc-500 font-bold uppercase">{dateStr}</div>
                      <div className="text-[10px] text-orange-600 dark:text-orange-400 uppercase font-bold">Open In Library</div>
                   </div>
                 </Link>
                 );
               })
          ...
          <Link to="/student/library" className="inline-block bg-orange-500 text-white font-bold uppercase text-xs px-4 py-2 hover:-translate-y-0.5 transition-transform shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] border-2 border-zinc-900 dark:border-zinc-100">
            Browse Library
          </Link>
        </div>
...
function StudentSimulatorWrapper() {
  ...
  const [simulatedBatchId, setSimulatedBatchId] = useState(localStorage.getItem('simulatedBatchId') || '');
  const [batchStudents, setBatchStudents] = useState<any[]>([]);
  const [simulatedStudentId, setSimulatedStudentId] = useState(localStorage.getItem('simulatedStudentId') || '');
  ...
  useEffect(() => {
    ...
    const fetchStudents = async () => {
      try {
        const q = query(collection(db, 'users'), where('batchId', '==', simulatedBatchId));
        const snaps = await getDocs(q);
        const students: any[] = [];
        snaps.forEach(d => {
  ...
  const simulatedUser = simulatedStudentData 
     ? { ...simulatedStudentData, uid: simulatedStudentId, isSimulatedAdmin: true } 
     : { ...authCtx.user, role: 'student', batchId: simulatedBatchId, isSimulatedAdmin: true };
      ...
      <div className="bg-yellow-400 text-yellow-900 border-b-4 border-yellow-500 px-4 py-2 flex flex-col items-center justify-between font-bold text-xs uppercase shadow-md relative z-50 gap-2">
         <div className="flex w-full items-center justify-between flex-wrap gap-2 mb-2 sm:mb-0">
           <div className="flex flex-wrap items-center gap-2">
             <span className="bg-yellow-900 text-yellow-400 px-2 py-1">Simulation Mode</span>
             <span>Batch:</span>
             <select 
             ...
             >
               ...
               {batchStudents.map(s => <option key={s.id} value={s.id}>{s.fullName || s.email}</option>)}
             </select>
           </div>
           
           <div className="flex gap-2">
             <Link to="/admin" className="bg-zinc-900 text-white px-3 py-1.5 border border-zinc-700 hover:-translate-y-0.5 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.5)] transition-transform whitespace-nowrap">
                Exit Simulator
             </Link>
           </div>
         </div>
         {simulatedStudentId && (
            <div className="w-full text-left text-yellow-800 bg-yellow-500/30 p-1 mt-1 border border-yellow-500 flex items-center justify-between" style={{ fontSize: '10px' }}>
              <span>ℹ️ Working as: {batchStudents.find(s => s.id === simulatedStudentId)?.fullName} - Payments and quizzes submitted now will create real records for this student.</span>
            </div>
         )}
      </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white dark:bg-zinc-900 border-4 border-zinc-900 dark:border-zinc-100 p-6 max-w-sm w-full shadow-[8px_8px_0px_0px_rgba(24,24,27,1)] dark:shadow-[8px_8px_0px_0px_rgba(244,244,245,1)]">
        <h3 className="font-black text-xl uppercase mb-4 text-zinc-900 dark:text-zinc-100 border-b-2 border-zinc-200 dark:border-zinc-800 pb-2">Notice</h3>
        <p className="font-bold text-sm text-zinc-700 dark:text-zinc-300 mb-6 whitespace-pre-wrap">{alertMsg}</p>
        <button 
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-sans flex flex-col">
        ...
        <main className="flex-1">
          <Routes>
            ...
            <Route path="/admin/library" element={<ProtectedRoute adminOnly><AdminLibrary /></ProtectedRoute>} />
            <Route path="/admin/results/:examId?" element={<ProtectedRoute adminOnly><AdminResults /></ProtectedRoute>} />
            ...
            <Route path="/student" element={<StudentSimulatorWrapper />}>
              <Route index element={<ProtectedRoute><StudentDashboard /></ProtectedRoute>} />
              <Route path="library" element={<ProtectedRoute><StudentLibrary /></ProtectedRoute>} />
              <Route path="payments" element={<ProtectedRoute><StudentPayments /></ProtectedRoute>} />
              <Route path="exams" element={<Navigate to="/student/library" replace />} />
            </Route>
          </Routes>
        </main>
      </div>
